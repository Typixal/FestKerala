...
/** Apply site configuration to the generated HTML shell. */
...
/** Replay the most recent Vite build error to newly connected clients. */
...
/** Ensure full reload when a React Refresh boundary disappears. */
...
/** Dev-only plugin exposing a story registry for the Figma preview. */
